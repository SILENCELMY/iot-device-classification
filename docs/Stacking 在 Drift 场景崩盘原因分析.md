...
| ----------------- | ---- | ----------- | -------------- | ----------- | ----- |
| **LORO R2+R4→R3** | 3669 | 0.5455      | 0.6148         | **-0.0693** | 严重崩盘  |
...
![Stacking Collapse Analysis](stacking_collapse_analysis.png)
...
![Stacking Meta-Learner Deep Analysis](stacking_meta_learner_analysis.png)
