...
| Single-round 平均表现 | 约 0.94-0.96 macro-F1 | 已核对：all_features 跨 5 模型的单任务均值 R2=0.9536 / R3=0.9613 / R4=0.9416，总均值 0.9522。**随机划分口径 = session 内上界（§8.4/§18）**：G0 时间块对照实测 random−time_block 差 R4 +0.052~+0.068、R2/R3 ≤ ±0.015；主线外环境 R6 高达 +0.155~+0.206、R7 +0.031~+0.043。处置 = 只加注不重跑（登记表 G0-GRID 行追记，2026-08-29） |
